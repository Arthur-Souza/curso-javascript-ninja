...
*/
// ES5
var championship = 'Copa Mundial';

// ES6
// let championship = 'Copa Mundial';
...
*/
// ES5
var teams = ['Brasil', 'Alemanha', 'China', 'EUA', 'Agentina']

// ES6
//let teams = ['Brasil', 'Alemanha', 'China', 'EUA', 'Agentina']
...
function showTeamPosition(position) {
    ...
    if(realPosition < 0 || realPosition > teams.length)
        return "Não temos a informação do time que está nessa pósição."
...
function convertToHex(cor) {
    switch (cor) {
        ...
        case 'rosa':
            return "O hexadecimal para a cor " + cor + " é #FF1493";
        default:
