(function() {
  ...
  */
  ...
  var arthur = new Person('Arthur', "Souza", 19);
  var joao = new Person('João', "Souza", 25);
  var maria = new Person('Maria', "Souza", 30);
  ...
  */
  ...
  console.log(maria.getFullname() + " tem " + arthur.getAge() + " anos.");
