(function() {
    ...
    */
    ...
    console.log([9,8,7,6,5,4,3,2,1].toString());
    ...
    */
    ...
    var sudeste = ['São Paulo', 'Rio de Janeiro', 'Minas Gerais', 'Epirito Santos'];
    ...
    */
    var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernanbuco', 'Piauí', 'Rio Grande do Norte', 'Seará'];
    ...
    */
    ...
    if (qtdLetras) {
        console.log("Sim, todos os estados tem mais de 7 letas!");
    } else {
    ...
    */
    ...
    var hasCE = brasil.some(function(item) {
        return item === 'Ceará';
    })
