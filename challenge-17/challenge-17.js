(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Arthur Souza'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, ''));
  ...
  */
  ...
  console.log(text.replace(/A/g, 4));
  ...
  */
  ...
  console.log(text.replace(/(O Centauro de Luvas)/, function(capturaTotal) { return capturaTotal.toUpperCase(); }));
  ...
  */
  ...
  function getMonthNumber(monthNeme) {
    var month = {
      janeiro: '01',
      fevereiro: '02',
      março: '03',
