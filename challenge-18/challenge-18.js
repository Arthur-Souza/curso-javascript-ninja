...
function cleanCPF(cpf) {
  return cpf.replace(/[^\d]/g, function(regex) {
    return ''
  })
}
...
var regexFormaterCPF = /(\d{3})(\d{3})(\d{3})(\d{2})/g

function formaterCPF(regex, cap1, cap2, cap3, cap4) {
  return cap1 + '.' + cap2 + '.' + cap3 + '-' + cap4;
}

console.log(cpfClean.replace(regexFormaterCPF, formaterCPF))
